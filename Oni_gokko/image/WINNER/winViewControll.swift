//
//  winViewControll.swift
//  Oni_gokko
//
//  Created by 若林俊輔 on 2015/10/11.
...
class winViewController: UIViewController, UITextViewDelegate, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        timer =  NSTimer.scheduledTimerWithTimeInterval(1.0 ,target:self,selector:Selector("setRoot"),userInfo: nil, repeats: true);
